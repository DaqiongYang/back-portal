  ...
  <div class="container">
    <div class="card mb-3">
      <div class="card-body">
        ...
        <p>
          <code>font-awesome</code> v4.7.0 共 675 个图标，详见
          <a href="http://fontawesome.io/icons/"
             target="_blank">font-awesome 官网
        ...
        <template v-for="icon in icons">
          {{ icon.name }}
            <div v-for="l in icon.list" :key="l">
              <i class="fa fa-icon"
                 :class="[`fa-${l}`]"></i>{{ `fa-${l}` }}
            </div>
        </template>
      ...
      icons: [
        {
          ...
          list: ['file', 'file-archive-o', 'file-audio-o', 'file-code-o', 'file-excel-o', 'file-image-o', 'file-movie-o', 'file-o', 'file-pdf-o', 'file-photo-o', 'file-picture-o', 'file-powerpoint-o', 'file-sound-o', 'file-text', 'file-text-o', 'file-video-o', 'file-word-o', 'file-zip-o']
        }, {
          name: 'Spinner Icons',
